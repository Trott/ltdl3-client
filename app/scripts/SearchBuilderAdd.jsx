        ...
        render: function () {
            ...
            return (
                <div className="input-group-btn">
                    ...
                    <button type="button" onClick={this.remove} className="tip btn btn-default" data-toggle="dropdown" title="Click and choose a selector to add a new row"><span className={"glyphicon glyphicon-" + (this.state.isAdd ? "plus" : "minus")}></span></button>
